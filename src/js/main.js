...
const sharePostFaceBook = () => {
	$('.lAS__listItem.share').click(() => {
		...
		$('.lAS__listItem.share').attr(
			'href',
			`javascript:window.open('https://www.facebook.com/sharer/sharer.php?kid_directed_site=0&sdk=joey&u=${url}&display=popup&ref=plugin&src=share_button','popup','width=600,height=300')`
		);
	});
};
