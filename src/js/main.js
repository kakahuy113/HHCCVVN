...
const sharePostFaceBook = () => {
	$('.shareface').click((e) => {
		...
		window.open(`https://www.facebook.com/sharer/sharer.php?kid_directed_site=0&sdk=joey&u=${url}&display=popup&ref=plugin&src=share_button,popup,width=600,height=300)`)
		})
}
//share tweet\
const shareTweet = () => {
...
const getAPIBonus = () => {
	const btn = document.querySelector(".lAS__listItem.bonus");
	if (btn) {
